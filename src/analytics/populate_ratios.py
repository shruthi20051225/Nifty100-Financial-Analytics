    ...
    rows.append(
        {
            ...
            "operating_profit_margin_pct": operating_profit_margin(
                r["operating_profit"], r["sales"]
            ),
            "return_on_equity_pct": return_on_equity(
                r["net_profit"], r["equity_capital"], r["reserves"]
            ),
            "debt_to_equity": debt_to_equity(
                r["borrowings"], r["equity_capital"], r["reserves"]
            ),
            "interest_coverage": interest_coverage(
                r["operating_profit"], r["other_income"], r["interest"]
            ),
            "asset_turnover": asset_turnover(r["sales"], r["total_assets"]),
